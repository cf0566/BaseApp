package com.cpic.taylor.application.flash;
...
import com.cpic.taylor.application.flash.effect.AccordionTransformer;
import com.cpic.taylor.application.flash.effect.CubeTransformer;
import com.cpic.taylor.application.flash.effect.DefaultTransformer;
import com.cpic.taylor.application.flash.effect.DepthPageTransformer;
import com.cpic.taylor.application.flash.effect.InRightDownTransformer;
import com.cpic.taylor.application.flash.effect.InRightUpTransformer;
import com.cpic.taylor.application.flash.effect.RotateTransformer;
import com.cpic.taylor.application.flash.effect.ZoomOutPageTransformer;
import com.cpic.taylor.application.flash.listener.FlashViewListener;
...
//	  System.out.println("测试bug111：：：imageUris.size()"+imageUris.size());
	  ...
	  for (int i = 0; i < imageUris.size(); i++)
	  {
	   ...
	   imageView.setScaleType(ScaleType.CENTER_CROP);// X和Y方向都填满
//	   imageLoaderTools.displayImage(imageUris.get(i), imageView);
		Glide.with(context).load(imageUris.get(i)).placeholder(R.drawable.empty_photo).into(imageView);//改用Glide加载图片速度更快
